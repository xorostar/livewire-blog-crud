                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" x-model = "converter.squareFoot" class="form-control" name="" id="square-foot" class="form-control" placeholder=""
                                       @keyup="
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" x-model="converter.squareYard" id="square-yard" class="form-control" name=""class="form-control" placeholder=""
                                       @keyup="
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" x-model="converter.squareMeters" class="form-control" name="" id="square-meters" class="form-control" placeholder=""
                                       @keyup="
